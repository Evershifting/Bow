...
public class bowAndArrow : MonoBehaviour
{
    ...
    //Reference to Trajectory script
    public TrajectoryProjection trajectoryScript;
    ...
    float arrowStartX;
    float length;
    float baseForce = 25f; //base value of the force pushing arrow
    ...
    void Start()
    {
        ...
        {
            new Vector3(-0.44f, 1.43f, 2f),
            new Vector3(-0.44f, -0.06f, 2f),
            new Vector3(-0.43f, -1.32f, 2f)
        };
    ...
    {
        // Очищаем траекторию при создании новой стрелы
        ...
        if (arrows > 0)
        {
            ...
            // получаем трансформ, от которого будет строить траекторию
            trajectoryScript.trajectoryStart = arrow.transform;
        }
        else
        {
            // no arrow is left,
